            ...
            <li class="treeview" id="OrderMainNav">
              ...
              <ul class="treeview-menu">
				...
				<?php if(in_array('createOrderNew', $user_permission)): ?>
                  <li id="createOrderNewSubMenu"><a href="<?php echo base_url('ordersNew/create') ?>"><i class="fa fa-circle-o"></i> Add order[menu]</a></li>
                <?php endif; ?>-->
                <?php if(in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
                <li id="manageOrderSubMenu"><a href="<?php echo base_url('ordersNew') ?>"><i class="fa fa-circle-o"></i> Manage Orders</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
